...
#include <TFT_eSPI.h>
#include "sb_logo.h"                 //Image 1
#include "SB_image.h"                 //Image 2
...
void loop() {
 ...
 ipsdisp.pushImage(0,0,240,320,SB_image2);    //ipsdisp.pushImage(x1,y1,x2,y2,array of image 2 containting 16-bit RGB565 data of each pixel) 
 ipsdisp.setCursor(0, 295,4);              //ipsdisp.setCurser(x axis,y axis,text font style i.e 1/2/4/6)
 ipsdisp.setTextColor(TFT_CYAN,TFT_BLACK); //ipsdisp.setTextColor(text color,text background color)
